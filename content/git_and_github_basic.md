...
url: "/2017/09/git_and_github_basic"
description: "介紹 Git 概念及基礎指令，並用 SSH 同步到 GitHub"
tags: ["git", "github", "ssh", "git-bash", "win10", "macos"]
categories: ["application"]
# featuredImage: "https://res.cloudinary.com/dcvgho2zc/image/upload/v1568902624/git-logo_xbrhxo.png"
# featuredImageDescription: "Git Logo"
dropCap: false
displayInMenu: false
displayInList: true
draft: false
resources:
- name: featuredImage
  src: "https://res.cloudinary.com/dcvgho2zc/image/upload/v1568902624/git-logo_xbrhxo.png"
  params:
...
- [學習目標](#學習目標)
- [學習內容](#學習內容)
    - [Git 跟 GitHub 是什麼](#git-跟-github-是什麼)
        - [Git 觀念](#git-觀念)
    - [建立 GitHub 帳號](#建立-github-帳號)
    - [Git 環境設定](#git-環境設定)
    - [設定 Git 識別資料](#設定-git-識別資料)
    - [建立 SSH Key 並增加到 GitHub](#建立-ssh-key-並增加到-github)
    - [建立 Project 並上傳到 GitHub](#建立-project-並上傳到-github)
    - [push 修改過的 Project 到 GitHub](#push-修改過的-project-到-github)
